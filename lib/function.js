...
const ws = require('ws'); // 1. Import ws dulu
            ...
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    contextInfo: {
                        ...
                        // isForwarded dihapus supaya tulisan "Diteruskan" hilang
                    },
        ...
        sections: [
            {
                ...
                rows: [
                    { title: "Ping", description: "Cek status jaringan & info server", id: `${p}ping` }
                ]
            }
        ]
    };
